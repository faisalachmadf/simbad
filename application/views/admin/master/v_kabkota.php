            ...
            <div class="col-lg-12 ">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary"><a href=" <?= base_url('admin/master/Kabkota/add'); ?>" class="btn btn-add btn-primary" ><i class="fa fa-plus"></i> Tambah</a></h6>
            ...
            $(function () {
              $('#kabkota').DataTable({
               ...
               /* 'processing': true,
                ...
                'order': [[3, 'asc']],*/
                "ajax": {
                      url : "<?=base_url('admin/master/Kabkota/get_data') ?>",
                      type : 'GET'
                  },
