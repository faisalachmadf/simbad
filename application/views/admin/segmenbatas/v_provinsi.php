            ...
            <div class="col-lg-12 ">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary"><a href=" <?= base_url('admin/segmenbatas/Provinsi/add'); ?>" class="btn btn-add btn-primary" ><i class="fa fa-plus"></i> Tambah</a></h6>
                ...
                <div class="card-body">
                  <table class="table" id="provinsi">
                     <thead class="thead-dark  table-striped"> 
                      <tr>
                        <th scope="col">No</th>
                        <th scope="col" style="width: 180px;">Batas antara</th>
            ...
            $(function () {
              $('#provinsi').DataTable({
               ...
               /* 'processing': true,
                ...
                'order': [[3, 'asc']],*/
                "ajax": {
                      url : "<?=base_url('admin/segmenbatas/Provinsi/get_data') ?>",
                      type : 'GET'
                  },
